...
<head>
  ...
  <title>ALIM-27 "Final Stage Preparation Course" (BOM)</title>
...
<body>
  ...
  <div id="login-page">
    <div class="login-container">
      <div class="welcome-message">
        <h1 class="bangla-font">ALIM-27 "Final Stage Preparation Course"</h1>
  ...
  <div id="main-page" style="display: none;">
    ...
    <footer class="site-footer">
      © 2025 ALIM-27 "Final Stage Preparation Course" (BOM). All rights reserved.
    </footer>
  </div>
...
function loadSubmissions() {
  fetch(WEB_APP_URL + '?action=getSubmissions')
    ...
    .then(data => {
      ...
      // শুধুমাত্র ALIM-27 ব্যাচ ফিল্টার করুন
      const alim27Submissions = data.filter(item => 
